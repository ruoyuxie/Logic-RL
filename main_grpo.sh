set -x
MODEL_PATH=/usr/project/xtmp/rx55/projects/long_cot/results/logic-rl_p2/actor/global_step_980
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.default_local_dir=/usr/project/xtmp/rx55/projects/long_cot/results/logic-rl_5ppl_full_continue\
